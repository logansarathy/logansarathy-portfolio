const styles = `
  ...
  .pf .contact-btn { font-family: var(--mono); font-size: 12px; letter-spacing: 0.12em; text-transform: uppercase; padding: 0.9rem 2rem; border-radius: 2px; text-decoration: none; transition: all 0.2s; border: none; cursor: pointer; }
  ...
  @media (max-width: 600px) {
    .pf .case-body { grid-template-columns: 1fr; }
    .pf .nav-links { gap: 1.25rem; }
    .pf #hero { padding: 6rem 1.5rem 3rem; }
  }
`;
